<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-button
        v-permission="['GET /admin/config/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
      ...
      <el-button
        v-permission="['POST /admin/config/create']"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
        @click="handleCreate"
    ...
    >
      ...
      <el-table-column align="center" label="配置编码" prop="code" />

      <el-table-column align="center" label="配置名称" prop="name" />

      <el-table-column align="center" label="配置描述" prop="message" />

      <el-table-column align="center" label="配置码值" prop="value" />
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            v-permission="['POST /admin/config/delete']"
            type="danger"
            size="mini"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="配置描述" prop="message">
          <el-input v-model="dataForm.message" />
        </el-form-item>

        <el-form-item label="配置码值" prop="value">
