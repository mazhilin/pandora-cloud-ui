  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="市场零售价格" prop="counterPrice">
          <el-input v-model="goods.counterPrice" placeholder="0.00">
            <template slot="append">元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="标准会员价格" prop="retailPrice">
          <el-input v-model="goods.retailPrice" placeholder="0.00">
            <template slot="append">元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="高级会员价格" prop="retailPrice">
          <el-input v-model="goods.memberPrice" placeholder="0.00">
            <template slot="append">元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="虚拟销售量" prop="virtuals">
          <el-input v-model="goods.virtuals" />
        </el-form-item>
        ...
        <el-form-item label="商品画廊">
          <el-upload
            ...
            accept=".jpg,.jpeg,.png,.gif"
          >
            <img v-if="goods.gallery" :src="goods.gallery" class="avatar" />
            <i v-else class="el-icon-plus avatar-uploader-icon" />
          </el-upload>
        </el-form-item>
    ...
    <el-card class="box-card">
      <h3>商品参数</h3>
      <el-button :plain="true" type="primary" @click="handleAttributeShow"
        >添加</el-button
      >
  ...
  methods: {
    init: function () {
      ...
      detailGoods(goodsId).then((response) => {
        ...
        this.galleryFileList.push({ url: this.goods.gallery });
    ...
    uploadGalleryUrl: function (response) {
      this.goods.gallery = response.data.url;
    },
