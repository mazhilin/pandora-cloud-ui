<template>
  <div class="app-container">
    ...
    >
      <el-table-column align="center" width="100px" label="点赞ID" prop="id" sortable/>
      <el-table-column align="center" label="点赞来源" prop="sourceType">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.sourceType | formatSourceType }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column align="center" label="点赞编号" prop="code"/>
      <el-table-column align="center" label="点赞名称" prop="name"/>
      <el-table-column align="center" label="点赞主体" prop="subjectId"/>
      <el-table-column align="center" label="点赞作品" prop="subjectName"/>
      <el-table-column align="center" label="IP地址" prop="ipAddress"/>
      <el-table-column align="center" label="点赞时间" prop="likeTime"/>
